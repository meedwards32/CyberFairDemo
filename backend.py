...
def home():
    ...
    <head>
        ...
        <!--Multi-colored Chrome Tab Icon: --><link rel="icon" href="https://cdn-icons-png.flaticon.com/512/722/722463.png">
        <!--Light Grey Chrome Tab Icon: <link rel="icon" href="https://icons.veryicon.com/png/o/application/animaui/chrome-70.png"> -->
        <!--Dark Grey Chrome Tab Icon: <link rel="icon" href="https://image.pngaaa.com/450/4965450-middle.png"> -->
        <title>New Tab</title>
        <style>
            body {
                margin: 0;
...
def search():
    searchQuery = request.form['query']  #Get the search query from the form 
    ...
    with open('search_queries.txt', 'a') as file:
        file.write(f"{timestamp}: {searchQuery}\n")
